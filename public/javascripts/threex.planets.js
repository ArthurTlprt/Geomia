...
THREEx.Planets.createEarth	= function(){
	...
	var material	= new THREE.MeshPhongMaterial({
		map		: textureloader.load(THREEx.Planets.baseURL+'images/earth_map_2048x1024.jpg'),
		bumpMap		: textureloader.load(THREEx.Planets.baseURL+'images/earth_bump_2048x1024.jpg'),
		bumpScale	: 0.05,
		specularMap	: textureloader.load(THREEx.Planets.baseURL+'images/earth_specular_2048x1024.jpg'),
...
THREEx.Planets.createEarthCloud	= function(){
	...
	imageMap.src	= THREEx.Planets.baseURL+'images/earth_clouds_2048x1024.jpg';
